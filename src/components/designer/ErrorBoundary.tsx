...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Design Designer Error:', error, errorInfo);
  }
      ...
      <Card className="max-w-md w-full animate-fade-in shadow-lg">
        ...
        <CardContent className="space-y-4">
          <div className="text-center text-muted-foreground text-sm">
            We encountered an unexpected error while processing your design. 
            Don't worry - your work is likely still saved.
          </div>
